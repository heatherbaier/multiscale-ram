...
class ActionNetwork(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        input_size = 2 * 256
        self.fc_class = nn.Linear(input_size, output_size)
        self.fc_cont = nn.Linear(input_size, 1)
...
#         print("H_t shape: ", h_t.shape)
        ...
        a_t_class = F.log_softmax(self.fc_class(h_t), dim = 0).unsqueeze(0)
        a_t_cont = self.fc_cont(h_t)
