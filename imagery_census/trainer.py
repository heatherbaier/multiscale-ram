...
#             is_best = valid_acc > self.best_valid_acc
    ...
    def train_one_epoch(self, epoch):
        ...
        with tqdm(total=self.num_train) as pbar:
            for i, (x, y, y_cont, census) in enumerate(self.train_loader):
...
#                     print("L_t[0:9]: ", l_t[0:9])
                ...
                # last iteration
                h_t, l_t, b_t, log_probas, p, cont_pred = self.model(x, l_t, h_t, last = True, census = census)
#                 print("CONTINOUS PREDICTION: ", cont_pred)
...
#                 print("LOCS: ", locs)
                ...
                loss_cont = self.criterion(cont_pred, y_cont.to(self.device))
                
#                 print("CONTINOUS LOSS: ", loss_cont)
...
#                     print("LOCS: ", locs)
    ...
    def validate(self, epoch):
        ...
        for i, (x, y, y_cont, census) in enumerate(self.valid_loader):
            x, y = x.to(self.device), y.to(self.device)
...
#             print("BASELINES: ", baselines)
    ...
    def test(self):
        ...
        for i, (x, y, y_cont, census) in enumerate(self.test_loader):
            x, y = x.to(self.device), y.to(self.device)
            ...
            # last iteration
            h_t, l_t, b_t, log_probas, p = self.model(x, l_t, h_t, last = True, census = census)
    ...
    @torch.no_grad()
    def predict(self, epoch, x, y, y_cont, census, checkpoint):
