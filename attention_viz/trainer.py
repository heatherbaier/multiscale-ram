...
#         accs = AverageMeter()
        ...
        with tqdm(total=self.num_train) as pbar:
            for i, (x, y_cont, muni_id) in enumerate(self.train_loader):
                ...
                for t in range(self.num_glimpses - 1):
                    ...
                    h_t, l_t, b_t, p = self.model(x, l_t, h_t, muni_id, epoch)
                ...
                # last iteration
                h_t, l_t, b_t, p, cont_pred = self.model(x, l_t, h_t, muni_id, epoch, last = True)
    ...
    def validate(self, epoch):
        ...
        for i, (x, y_cont, muni_id) in enumerate(self.valid_loader):
